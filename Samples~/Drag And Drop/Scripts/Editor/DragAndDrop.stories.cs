        ...
        public DragAndDropPage()
        {
            m_Stories.Add(new StoryBookStory("Main", () =>
            {
                ...
                var tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                        "Assets/Samples/App UI/1.0.0-pre.1/Drag And Drop/SampleResources/Drag And Drop/DragAndDropUI.uxml");
                var styleSheet = AssetDatabase.LoadAssetAtPath<ThemeStyleSheet>(
                    "Assets/Samples/App UI/1.0.0-pre.1/Drag And Drop/SampleResources/Drag And Drop/DragAndDropTheme.tss");
