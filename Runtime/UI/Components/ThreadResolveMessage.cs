...
namespace Unity.AppUI.UI
{
    ...
    [UxmlElement]
#endif
    public partial class ThreadResolveMessage : BaseVisualElement
    {
#if ENABLE_RUNTIME_DATA_BINDINGS
        ...
        public ThreadResolveMessage()
        {
            ...
            m_IconElement = new Icon { name = iconUssClassName, iconName = "check-circle", pickingMode = PickingMode.Ignore };
        ...
        void RefreshText()
        {
            ...
            m_TextElement.text = string.IsNullOrEmpty(m_AuthorName)
                ? "@AppUI:threadResolved"
                : "@AppUI:threadResolvedByAuthor";
            if (!string.IsNullOrEmpty(m_AuthorName))
            {
                m_TextElement.variables = new object[]
                {
            ...
            {
                m_TextElement.variables = null;
            }
#else
            m_TextElement.text = string.IsNullOrEmpty(m_AuthorName)
                ? "resolved this thread"
                : $"{m_AuthorName} resolved this thread";
#endif
        }

#if ENABLE_UXML_TRAITS
        /// <summary>
        /// Defines the UxmlFactory for the ThreadResolveMessage.
        /// </summary>
        public new class UxmlFactory : UxmlFactory<ThreadResolveMessage, UxmlTraits> { }

        /// <summary>
        /// Class containing the <see cref="UxmlTraits"/> for the <see cref="ThreadResolveMessage"/>.
        /// </summary>
        public new class UxmlTraits : BaseVisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                var el = (ThreadResolveMessage)ve;
